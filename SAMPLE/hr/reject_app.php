...
if (isset($_GET['application_id'])) {
    ...
    $sql = "UPDATE Applications SET application_status = 'Rejected' WHERE application_id = ?";
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['message'] = "Application rejected successfully, and the applicant has been notified.";
    } else {

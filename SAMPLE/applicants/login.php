...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $hr['password'])) {
            $_SESSION['applicant_id'] = $hr['applicant_id'];
            $_SESSION['applicant_name'] = $hr['applicant_name'];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO Applicants (applicant_name, email, password, created_at) 
        VALUES ('$applicant_name', '$email', '$password', CURRENT_TIMESTAMP)";
...
<div class="container">
    ...
    <?php else: ?>
        ...
        <form method="POST" action="login.php">
            <input type="text" name="applicant_name" placeholder="Applicant Name" required><br>
            <input type="email" name="email" placeholder="Email" required><br>
            <input type="password" name="password" placeholder="Password" required><br>
